...
if len(sys.argv) != 2:  
	sys.exit("Usage: run bird_song_diarization_hpf.py [cut-off frequency]")

fc=float(sys.argv[1])
#Create 10th order Butterworth high pass filter
order=10
fs=16000.#sampling frequency of the recordings
...
np.savetxt('numspeciesVSnumclust_hpf_'+sys.argv[1]+'.txt',numspeciesVSnumclust)
